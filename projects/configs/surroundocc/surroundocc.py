...
data_root = '/mnt/d/dataset/data/nuscenes/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/mnt/d/project/SurroundOcc-main/data/nuscenes_infos_test.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file='/mnt/d/project/SurroundOcc-main/data/nuscenes_infos_train.pkl',
    ...
    test=dict(type=dataset_type,
              data_root=data_root,
              ann_file='/mnt/d/project/SurroundOcc-main/data/nuscenes_infos_val.pkl',
              pipeline=test_pipeline, 
              occ_size=occ_size,
              pc_range=point_cloud_range,
              use_semantic=use_semantic,
