...
from projects.mmdet3d_plugin.datasets.det3d_dataset import Det3DDataset
...
class data_out_CustomNuScenesOccDataset(NuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def prepare_train_data(self, index):
        ...
        files = input_dict["img_filename"]
        imgs_file = []
        for i in files:
            name = "/media/vcc/LinuxData/project/" + i.split("./")[1]
            imgs_file.append(name)
        input_dict["img_filename"] = imgs_file
        # print("---------====----------")
        input_dict["occ_path"] = "/media/vcc/LinuxData/project/" + input_dict["occ_path"].split("./")[1]
