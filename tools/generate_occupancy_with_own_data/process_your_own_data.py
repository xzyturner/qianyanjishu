...
if __name__ == '__main__':
    ...
    parse.add_argument('--data_path', type=str, default="/home/vcc/project/urban/SurroundOcc-main/data/ours/gt_generation_template")
    parse.add_argument('--config_path', type=str, default='config.yaml')
    parse.add_argument('--len_sequence', type=int, default=1)
    parse.add_argument('--to_mesh', action='store_true', default=True)
